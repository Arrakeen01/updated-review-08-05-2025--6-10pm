...
-- Documents policies (matching the provided schema)
...
-- Templates policies - allow all authenticated users to read templates
...
-- Audit logs policies - users can only read their own logs
