/*
  ...
  1. Template Updates
    - Replace existing probation letter fields with comprehensive new structure
    - Add all required fields including nested objects for officers
    - Include proper validation rules and field types
    - Support complex data structures for reporting hierarchy

  2. Field Structure
    - Basic probationer information (name, DOB, qualification, etc.)
    - Service details (class category, dates, salary)
    - Probation assessment fields
    - Nested officer objects (Reporting, Countersigning, HOD)
