/*
  # Complete database schema setup for SPARK document management system

  1. New Tables
    - `documents` - Store processed documents with OCR data and metadata
    - `templates` - Document templates for field extraction
  ...
  2. Security
    ...
    - Proper access control for documents and templates
  ...
  4. Default Data
    - Insert built-in document templates
*/
